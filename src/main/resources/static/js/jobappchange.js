...
function hage() {
	if (j == 0) {
		i = document.getElementById("companysLength").value - 1;
	}
	j++;
	i++;
	// Tbody への参照を取得します
...
jQuery(function($) {
	...
	$(".toggle-dchange").click(function() {
		$(".toggle-dchange-open").slideToggle();
	});
	$(".toggle-achange").click(function() {
		$(".toggle-achange-open").slideToggle();
	});
});