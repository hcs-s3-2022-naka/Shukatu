package jp.ac.hcs.ShukatsuPortal;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String USER_SQL = "SELECT user_id, encrypted_password as password, CASE WHEN user_status IN('VALID') THEN TRUE WHEN user_status IN('LOCKED', 'INVALID') THEN FALSE ELSE NULL END FROM users WHERE user_id = ?";
